    ...
    public class SeedingService
    {
        ...
        public void SeedPackages()
        {
            ...
            Package p3 = new Package() { Title = "Athens one of the most historical cities in Europe.", 
                ...
                TripDate = new DateTime(2022, 9, 1),Discount=25, TripDuration = 3, Price = 400, Destinations = Destinations.Athens, PackageStatus = Status.Pending
            };
...
"In conclusion, one of Rome’s great joys is losing yourself in the narrow cobblestone streets that make up Centro Storico. Starting at Piazza del Popolo, three main roads form a trident leading toward Piazza Venezia and the Colosseum. Branching off are countless streets and alleyways where you’ll find churches with Baroque art, boutiques selling everything from carved wooden figurines to precious jewelry, private courtyards where the wealthiest Romans live, enticing gelaterias, cafés, and restaurants. Take your time and do as the Romans do—this is what la dolce vita is all about.",
            ...
            Package p6 = new Package() { Title = "Enjoy the colorfull Lisbon", 
                ...
                MainPhoto = "https://www.nationsonline.org/gallery/Portugal/Praca-do-Comercio-Lisbon.jpg", TripDate = new DateTime(2022, 4, 30), TripDuration = 3, Price = 329, Discount=30, Destinations = Destinations.Lisbon, PackageStatus = Status.Active };
            Package p7 = new Package() { Title = "Cappadocia", 
                Description = "Explore Cappadocia",
                Program = "1- Visiting city and museums 2-Barcelone Zoo  3-Seaside walk", MainPhoto = "https://d1hjkbq40fs2x4.cloudfront.net/2020-12-07/files/16072849260.jpg", TripDate = new DateTime(2022, 8, 15), TripDuration = 5, Price = 633, Discount = 20, Destinations = Destinations.Cappadocia, PackageStatus = Status.Active };
            Package p8 = new Package() { Title = "Cappadocia",
                Description = "Explore Cappadocia",
