...
namespace MyDatabase.Seeding
{
    public class SeedingService
    {
        ...
        public void SeedPackages()
        {
            ...
            {
                Title = "Barcelona, a city by the sea yet encircled by wooded mountains.",
            ...
            Package p2 = new Package()
            {
                ...
                MainPhoto = "https://fadeceilings.com/wp-content/uploads/2019/08/AdobeStock_65117955-720x460.jpeg",
                TripDate = new DateTime(2022, 5, 3),
                TripDuration = 3,
                Price = 699,
                Destinations = Destinations.Paris,
                PackageStatus = Status.Active
            };
            Package p3 = new Package()
            {
                Title = "Athens one of the most historical cities in Europe.",
                ...
                TripDate = new DateTime(2022, 9, 1),
                Discount = 25,
                TripDuration = 3,
                Price = 400,
                Destinations = Destinations.Athens,
...
"And of course The Sanctuary of Christ the King (Portuguese: Santuário de Cristo Rei) is a Catholic monument and shrine dedicated to the Sacred Heart of Jesus Christ overlooking the city of Lisbon situated in Almada, in Portugal.",
                MainPhoto = "https://www.nationsonline.org/gallery/Portugal/Praca-do-Comercio-Lisbon.jpg",
                TripDate = new DateTime(2022, 4, 30),
                TripDuration = 3,
                Price = 329,
                Discount = 30,
            ...
            {
                Title = "Cappadocia, a moon-like landscape",
                ...
                MainPhoto = "https://d1hjkbq40fs2x4.cloudfront.net/2020-12-07/files/16072849260.jpg",
                TripDate = new DateTime(2022, 8, 15),
                TripDuration = 5,
                Price = 633,
                Discount = 20,
                Destinations = Destinations.Cappadocia,
                PackageStatus = Status.Active
            };
            Package p8 = new Package()
            {
                Title = "Uzbekistan, the land of",
                Description = "Explore Cappadocia",
                Program = "1- Visiting city and museums 2-Barcelone Zoo  3-Seaside walk",
                MainPhoto = "https://d1hjkbq40fs2x4.cloudfront.net/2020-12-07/files/16072849260.jpg",
                TripDate = new DateTime(2023, 01, 1),
                TripDuration = 5,
                Price = 633,
                Discount = 20,
                Destinations = Destinations.Cappadocia,
